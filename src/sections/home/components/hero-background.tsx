          ...
          sx={[
            (theme) => ({
              ...theme.mixins.bgGradient({
                images: [
                  `linear-gradient(180deg, ${theme.vars.palette.grey[50]}, ${theme.vars.palette.primary.lighter} 71%, ${theme.vars.palette.primary.lighter} 100%)`,
              ...
              ...theme.applyStyles('dark', {
                ...theme.mixins.bgGradient({
                  images: [
                    `180deg, ${theme.vars.palette.grey[50]}, ${theme.vars.palette.primary.lighter} 71%, ${theme.vars.palette.primary.lighter} 100%`,
